...
public class TelaCadVendas extends TelaDeCadastro {
	...
	void salvar() {
		...
		try {
			...
			this.vendas.setIdVenda(Integer.parseInt(this.txtIdVenda.getText()));
			this.vendas.setIdCliente(Integer.parseInt(this.txtIdCliente.getText()));
			SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
			java.util.Date data = sdf.parse(this.txtData.getText());
			this.vendas.setData(data);
			this.vendas.setValTotal(Double.parseDouble(this.txtValorTotal.getText()));
			this.vendas.setDesconto(Double.parseDouble(this.txtDesc.getText()));
			this.vendas.setValPago(Double.parseDouble(this.txtPago.getText()));
