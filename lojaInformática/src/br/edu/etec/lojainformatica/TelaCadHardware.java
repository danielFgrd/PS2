...
public class TelaCadHardware extends TelaDeCadastro {
	...
	void salvar() {
		...
		try {
			...
			this.hardware.setPrecoUnit(Double.parseDouble(this.txtPrecoUnit.getText()));		
			this.hardware.setQuantAtual(Integer.parseInt(this.txtQtdeAtual.getText()));
			this.hardware.setQuantMinima(Integer.parseInt(this.txtQtdeMinima.getText()));
